...
import Coffee from '../../images/cacao.png';
import Idaho from '../../images/about_me2.png'
import Hola from '../../images/banana.png';
import usaf from '../../images/usaf_v2.png';
        ...
        <div className="About" id="about">
            ...
            <div className="AboutContent">
                ...
                <div className="AboutText">
                    <p>I'm Hunter and I'm from Idaho, where we power our computers with potatoes.</p>
            ...
            <ScrollAnimation animateIn='bounceInRight' duration={2} className="FixToTopIcon">
                <div className="AboutPictures">
                    <img src={usaf} alt="coffee cup with the text coder inside" className="AboutIcons"/>
                </div>
            </ScrollAnimation>
            </div>
        </div>
